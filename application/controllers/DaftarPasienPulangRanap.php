...
class DaftarPasienPulangRanap extends CI_Controller
{
    ...
    public function AmbilData()
    {
        ...
        $results    = $this->M_DaftarPasienPulangRanap->getDataTable($awal, $akhir, $jenispasien, $ruangan, $caritext,  $kondisipulang, '1');
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_DaftarPasienPulangRanap->count_all_data($awal, $akhir, $jenispasien, $ruangan, $caritext, $kondisipulang, '1'),
            "recordsFiltered" => $this->M_DaftarPasienPulangRanap->count_filtered_data($awal, $akhir, $jenispasien, $ruangan, $caritext, $kondisipulang, '1'),
            "data" => $data,
        );
    ...
    public function Cetak()
    {
        ...
        $result['datahasil']    = $this->M_DaftarPasienPulangRanap->getDataTable($awal, $akhir, $jenispasien, $ruangan, $caritext, $kondisipulang, '2');
        $result['datafilter']    = [
            'TglAwal' => $awal,
            'TglAkhir' => $akhir,
