...
<head>
    <?php $this->load->view("templates/header", $kirim) ?>
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php $this->load->view("templates/sidebar", $kirim) ?>

        <div id="content-wrapper">

            <div class="container-fluid">

                <?php $this->load->view("templates/topbar", $kirim);
                ?>

                <!-- DataTables -->
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="<?php echo base_url('admin/statuspegawai/add') ?>"><i class="fas fa-plus"></i> Add New</a>
                    </div>
                    <div class="card-body">
